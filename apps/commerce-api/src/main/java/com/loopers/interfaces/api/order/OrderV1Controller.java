...
public class OrderV1Controller {
    ...
    public ApiResponse<OrderV1Dto.OrderResponse> createOrder(
        ...
        List<OrderItemCommand> commands = request.items().stream()
            ...
            .toList();
        OrderInfo info = orderFacade.createOrder(authUser.loginId(), commands);
    ...
    public ApiResponse<List<OrderV1Dto.OrderResponse>> getOrders(
        ...
        List<OrderInfo> infos = orderFacade.getOrders(authUser.loginId(), resolvedStartAt, resolvedEndAt);
    ...
    public ApiResponse<OrderV1Dto.OrderResponse> getOrder(
        ...
        OrderInfo info = orderFacade.getOrder(authUser.loginId(), orderId);
        return ApiResponse.success(OrderV1Dto.OrderResponse.from(info));
    }
}
